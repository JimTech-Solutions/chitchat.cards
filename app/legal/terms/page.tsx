  ...
  return (
    <UserProvider> 
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 text-justify leading-relaxed">
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">10. Refund and Cancellation Policy</h2>
          <p className="mb-2"><strong>Refunds:</strong> All purchases made on our Service are final and non-refundable. We do not offer refunds for any products or services.</p>
          <p className="mb-2"><strong>Cancellation:</strong> You may cancel your subscription at any time by accessing your account settings. Cancellations will take effect at the end of the current billing period. No refunds will be provided for partial billing periods.</p>
        </section>
